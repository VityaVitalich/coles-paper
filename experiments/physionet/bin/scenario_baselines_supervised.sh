...
python ../../metric_learning.py \
    ...
    params.rnn.type="gru" params.rnn.hidden_size=128 params.train.n_epoch=30 \
    model_path.model="models/mles_model_for_finetuning.p" \
    --conf conf/dataset.hocon conf/mles_params.json
python -m scenario_physionet fit_finetuning \
    params.device="$SC_DEVICE" \
    params.rnn.type="gru" params.rnn.hidden_size=128 \
